...
channel_directory = '/home/tbochens/VideoCrawlers/results/Youtube'
video_directory = '/home/tbochens/VideoCrawlers/results/FiltYoutube'

channel_files <- list.files(path = channel_directory, pattern ='youtube_channels')
video_files <- list.files(path = video_directory, pattern = 'youtube_video')
