...
train_output = 'train_8.txt'
val_output = 'val_8.txt'

ranges_filename = '/home/tbochens/CNN/Split/Facebook/multisplit.json'
channels_filename = '/home/tbochens/VideoCrawlers/results/Facebook/facebook_pages.json'
videos_filenames = glob.glob('/home/tbochens/VideoCrawlers/results/Facebook/facebook_video_*.json')
...
with open(channels_filename, 'r') as ch_file:
    ...
    for chan in channels:
        followers[chan['page_name_id']] = chan['likes']
...
for video_file in videos_filenames:
    with open(video_file, 'r') as v_file:
        ...
        for vid in videos:
            ...
            view_count = float(vid['viewCount'])
            followers_count = float(followers[vid['page_name_id']])
            ...
            date = vid['updated_time']['date'][:len('yyyy-mm')]
            label = None
            idx = 0
